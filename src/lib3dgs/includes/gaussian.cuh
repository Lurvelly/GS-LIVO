...
public:
    ...
    void Export_to_pcd(PointCloud& pcd);
    void Create_from_pcd(PointCloud& pcd, float spatial_lr_scale);
    void Create_from_our_format_optimized(std::vector<GS_point>& GaussianCloud) ;
    void Create_from_our_format(std::vector<GS_point>& GaussianCloud);
    void Dump_to_our_format(std::vector<GS_point>& GaussianCloud,int size);
    void Create_from_our_format_with_depth_making(std::vector<GS_point>& GaussianCloud,
                                                                float Rcw_f[9],
                                                                float Pcw_f[3],
    ...
    void Create_from_pcd_our(PointCloud& pcd);
    ...
    void Save_ply_our(const std::filesystem::path& file_path,std::vector<GS_point>& GaussianCloud);

   void Save_ply_our2(const std::filesystem::path& file_path,std::vector<GS_point>& GaussianCloud);
public:
